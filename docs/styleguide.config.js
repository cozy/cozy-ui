...
module.exports = {
  ...
  sections: [
    ...
    {
      name: 'Intents',
      components: () => ['../react/IntentIframe', '../react/IntentDialogOpener']
    },
    {
      name: 'List',
      components: () => [
    ...
    },
    {
      name: 'Hooks',
      components: () => [
        '../react/hooks/useBrowserOffline',
        '../react/hooks/useConfirmExit',
        '../react/hooks/useCycle',
        '../react/hooks/useEventListener',
        '../react/hooks/usePeriodicRender'
      ]
    },
    {
      name: 'Labs',
  ...
  styleguideComponents: {
    ...
    TableOfContentsRenderer: path.join(
      __dirname,
      'components/TableOfContentsRenderer'
    ),
  ...
  webpackConfig: webpackMerge(require('./webpack.config'), {
    resolve: {
      alias: {
