...
- Modal : `withCross` is now `closable`. Deprecation warning. https://github.com/cozy/cozy-ui/pull/237
- Modal : `dismissAction` property has been added and will be called when clicking outside or on the cross. For now, secondaryAction will be copied into it if it is undefined. Deprecation warning. https://github.com/cozy/cozy-ui/pull/237
