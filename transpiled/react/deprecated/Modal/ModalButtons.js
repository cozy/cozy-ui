...
var ModalButtons = function ModalButtons(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: cx('u-flex', 'u-flex-wrap-reverse', 'u-flex-justify-end', styles['c-modal-footer--button'], className)
  }, children, secondaryText && secondaryAction && /*#__PURE__*/React.createElement(Button, {
    theme: secondaryType,
    onClick: secondaryAction,
    label: secondaryText,
    className: "u-flex-auto-s"
  }), primaryText && primaryAction && /*#__PURE__*/React.createElement(Button, {
    theme: primaryType,
