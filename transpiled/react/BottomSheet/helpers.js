...
export var computeBottomSpacer = function computeBottomSpacer(_ref6) {
  var backdrop = _ref6.backdrop,
      ...
      toolbarProps = _ref6.toolbarProps,
      offset = _ref6.offset;
...
export var getCssValue = function getCssValue(element, value) {
  return element ? parseFloat(getComputedStyle(element).getPropertyValue(value)) : 0;
};