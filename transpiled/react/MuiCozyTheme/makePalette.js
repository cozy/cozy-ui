...
export var makePalette = function makePalette(type, variant) {
  var paletteByTheme = {
    type: type,
    variant: variant,
    primary: {
      ...
      contrastText: getCssVariableValue('primaryContrastTextColor', type, variant)
    },
    secondary: {
      ...
      contrastText: getCssVariableValue('secondaryContrastTextColor', type, variant)
    },
    error: {
    ...
    warning: {
      ...
      contrastText: getCssVariableValue('warningColorContrastText', type, variant)
    },
    success: {
      ...
      contrastText: getCssVariableValue('successColorContrastText', type, variant)
    },
    info: {
    ...
    action: {
      ...
      disabledBackground: getCssVariableValue('actionColorDisabledBackground', type, variant),
    ...
    border: {
      ...
      ghostDisabled: getCssVariableValue('borderGhostDisabledColor', type, variant)
    },
    background: {
