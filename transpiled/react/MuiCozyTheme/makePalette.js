...
import { getCssVariableValue, getInvertedCssVariableValue } from "cozy-ui/transpiled/react/utils/color";
var opacityByTheme = {
  light: {
    action: {
      hoverOpacity: 0.04,
...
export var makePalette = function makePalette(type) {
  var getCssValue = type === 'dark' ? getInvertedCssVariableValue : getCssVariableValue;
  var paletteByTheme = {
    type: type,
    primary: {
