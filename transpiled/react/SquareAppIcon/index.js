...
var styles = {
  ...
  "SquareAppIcon-wrapper--light": "styles__SquareAppIcon-wrapper--light___2iR5Y",
  "SquareAppIcon-wrapper--dark": "styles__SquareAppIcon-wrapper--dark___1vYbb",
...
var useStyles = makeStyles(function (theme) {
  return {
    name: _defineProperty({
      ...
      textShadow: theme.variant === 'inverted' || theme.type === 'dark' ? '0px 0px 10px rgba(0, 0, 0, 0.10), 0px 0px 2px rgba(0, 0, 0, 0.20), 0.5px 0.5px 1px rgba(0, 0, 0, 0.50)' : undefined,
      width: '5.5rem',
      textAlign: 'center',
    ...
    tileWrapper: _defineProperty({
      cursor: 'pointer',
      // Whole block is clickable so we should display the pointer
      display: 'flex',
...
export var SquareAppIcon = function SquareAppIcon(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: cx(styles["SquareAppIcon-wrapper"], styles["SquareAppIcon-wrapper-".concat(variant)], styles["SquareAppIcon-wrapper--".concat(type)], (_cx3 = {}, _defineProperty(_cx3, classes.squareAppIconGhost, exceptionVariant.includes(variant)), _defineProperty(_cx3, classes.shadow, !exceptionVariant.includes(variant)), _cx3)),
    ...
    size: "large",
    overlap: "rectangular",
    style: variant === 'shortcut' && !IconContent ? _defineProperty({}, 'background', nameToColor(name)) : null
    ...
    className: cx(styles['SquareAppIcon-icon-container'], _defineProperty({}, styles['SquareAppIcon-icon-container-normal'], themeVariant === 'normal'))
  ...
  }) : IconContent ? IconContent : /*#__PURE__*/React.createElement("div", {
    className: "u-w-2 u-h-2"
  }, /*#__PURE__*/React.createElement(AppIcon, appIconProps)))))), display === 'detailed' ? /*#__PURE__*/React.createElement(ListItemText, {
    primary: appName,
