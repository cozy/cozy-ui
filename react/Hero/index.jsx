...
export const Hero = ({children, ...props}) =>
  <div {...props} className={styles.Hero}>{ children }</div>

export default Hero
export const Title = mkComponent('h2', {className: styles['Hero-title']})
export const Subtitle = mkComponent('h3', {className: styles['Hero-subtitle']})
export const Section = mkComponent('div', {className: styles['Hero-section']})
export const Sections = mkComponent('div', {className: styles['Hero-sections']})
