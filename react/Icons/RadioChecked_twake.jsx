// Automatically created, please run `scripts/generate-svgr-icon.sh assets/icons/twake/radio-checked_twake.svg` to regenerate;
import React from 'react'

function SvgRadioCheckedTwake(props) {
  return (
...
export default SvgRadioCheckedTwake
