// Automatically created, please run `scripts/generate-svgr-icon.sh assets/icons/twake/notification-email_twake.svg` to regenerate;
import React from 'react'

function SvgNotificationEmailTwake(props) {
  return (
...
export default SvgNotificationEmailTwake
