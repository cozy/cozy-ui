// Automatically created, please run `scripts/generate-svgr-icon.sh assets/icons/twake/permissions/home-permissions_twake.svg` to regenerate;
import React from 'react'

function SvgHomePermissionsTwake(props) {
  return (
...
export default SvgHomePermissionsTwake
