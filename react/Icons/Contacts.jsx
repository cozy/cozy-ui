...
function SvgContacts(props) {
  return (
    <svg viewBox="0 0 32 32" fill="none" {...props}>
      ...
      <g clipPath="url(#contacts_svg__clip0_3096_936)">
        <rect
          width={32}
          height={32}
          rx={10}
          fill="url(#contacts_svg__paint0_linear_3096_936)"
        />
        <g filter="url(#contacts_svg__filter1_d_3096_936)" fill="#fff">
      ...
      <defs>
        <filter
          id="contacts_svg__filter0_d_3096_936"
          x={3.753}
          y={4.569}
          width={24.477}
          height={23.463}
        ...
        <filter
          id="contacts_svg__filter1_d_3096_936"
          x={4.16}
          y={4.731}
          width={23.66}
          height={23.714}
        ...
        <linearGradient
          id="contacts_svg__paint0_linear_3096_936"
          x1={5.548}
          y1={29.127}
          x2={30.188}
          y2={1.958}
