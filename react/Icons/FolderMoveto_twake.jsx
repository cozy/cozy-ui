// Automatically created, please run `scripts/generate-svgr-icon.sh assets/icons/twake/folder-moveto_twake.svg` to regenerate;
import React from 'react'

function SvgFolderMovetoTwake(props) {
  return (
...
export default SvgFolderMovetoTwake
