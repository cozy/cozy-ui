// Automatically created, please run `scripts/generate-svgr-icon.sh assets/icons/twake/star-outline_twake.svg` to regenerate;
import React from 'react'

function SvgStarOutlineTwake(props) {
  return (
...
export default SvgStarOutlineTwake
