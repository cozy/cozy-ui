// Automatically created, please run `scripts/generate-svgr-icon.sh assets/icons/twake/permissions/connected-clients_twake.svg` to regenerate;
import React from 'react'

function SvgConnectedClientsTwake(props) {
  return (
...
export default SvgConnectedClientsTwake
