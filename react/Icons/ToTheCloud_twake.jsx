// Automatically created, please run `scripts/generate-svgr-icon.sh assets/icons/twake/to-the-cloud_twake.svg` to regenerate;
import React from 'react'

function SvgToTheCloudTwake(props) {
  return (
...
export default SvgToTheCloudTwake
