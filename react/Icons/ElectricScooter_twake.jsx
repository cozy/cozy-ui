// Automatically created, please run `scripts/generate-svgr-icon.sh assets/icons/twake/electric-scooter_twake.svg` to regenerate;
import React from 'react'

function SvgElectricScooterTwake(props) {
  return (
...
export default SvgElectricScooterTwake
