// Automatically created, please run `scripts/generate-svgr-icon.sh assets/icons/twake/permissions/permissions_twake.svg` to regenerate;
import React from 'react'

function SvgPermissionsTwake(props) {
  return (
...
export default SvgPermissionsTwake
