// Automatically created, please run `scripts/generate-svgr-icon.sh assets/icons/twake/electric-car_twake.svg` to regenerate;
import React from 'react'

function SvgElectricCarTwake(props) {
  return (
...
export default SvgElectricCarTwake
