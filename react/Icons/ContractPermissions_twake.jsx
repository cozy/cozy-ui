// Automatically created, please run `scripts/generate-svgr-icon.sh assets/icons/twake/permissions/contract-permissions_twake.svg` to regenerate;
import React from 'react'

function SvgContractPermissionsTwake(props) {
  return (
...
export default SvgContractPermissionsTwake
