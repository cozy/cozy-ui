// Automatically created, please run `scripts/generate-svgr-icon.sh assets/icons/twake/merge_twake.svg` to regenerate;
import React from 'react'

function SvgMergeTwake(props) {
  return (
