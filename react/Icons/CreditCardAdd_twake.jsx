// Automatically created, please run `scripts/generate-svgr-icon.sh assets/icons/twake/credit-card-add_twake.svg` to regenerate;
import React from 'react'

function SvgCreditCardAddTwake(props) {
  return (
...
export default SvgCreditCardAddTwake
