// Automatically created, please run `scripts/generate-svgr-icon.sh assets/icons/twake/illus/device-laptop_twake.svg` to regenerate;
import React from 'react'

function SvgDeviceLaptopTwake(props) {
  return (
...
export default SvgDeviceLaptopTwake
