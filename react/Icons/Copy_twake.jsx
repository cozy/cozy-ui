// Automatically created, please run `scripts/generate-svgr-icon.sh assets/icons/twake/copy_twake.svg` to regenerate;
import React from 'react'

function SvgCopyTwake(props) {
  return (
