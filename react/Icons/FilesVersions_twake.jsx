// Automatically created, please run `scripts/generate-svgr-icon.sh assets/icons/twake/permissions/files-versions_twake.svg` to regenerate;
import React from 'react'

function SvgFilesVersionsTwake(props) {
  return (
...
export default SvgFilesVersionsTwake
