// Automatically created, please run `scripts/generate-svgr-icon.sh assets/icons/twake/refresh_twake.svg` to regenerate;
import React from 'react'

function SvgRefreshTwake(props) {
  return (
...
export default SvgRefreshTwake
