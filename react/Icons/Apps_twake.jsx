// Automatically created, please run `scripts/generate-svgr-icon.sh assets/icons/twake/permissions/apps_twake.svg` to regenerate;
import React from 'react'

function SvgAppsTwake(props) {
  return (
    <svg viewBox="0 0 16 16" {...props}>
      <path d="M7 1a1 1 0 00-1-1H1a1 1 0 00-1 1v5a1 1 0 001 1h5a1 1 0 001-1V1z" />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
