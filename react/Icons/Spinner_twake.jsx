// Automatically created, please run `scripts/generate-svgr-icon.sh assets/icons/twake/spinner_twake.svg` to regenerate;
import React from 'react'

function SvgSpinnerTwake(props) {
  return (
...
export default SvgSpinnerTwake
