// Automatically created, please run `scripts/generate-svgr-icon.sh assets/icons/illus/photos-text.svg` to regenerate;
import React from 'react'

function SvgPhotosText(props) {
  return (
    <svg viewBox="0 0 554 140" fill="none" {...props}>
      <path
      ...
      <defs>
        ...
        >
          <stop offset={0.23} stopColor="#50BBC7" />
          <stop offset={1} stopColor="#73DEEA" />
        </linearGradient>
        <linearGradient
