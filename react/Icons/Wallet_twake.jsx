// Automatically created, please run `scripts/generate-svgr-icon.sh assets/icons/twake/wallet_twake.svg` to regenerate;
import React from 'react'

function SvgWalletTwake(props) {
  return (
