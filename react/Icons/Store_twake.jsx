// Automatically created, please run `scripts/generate-svgr-icon.sh assets/icons/twake/illus/store_twake.svg` to regenerate;
  ...
  return (
    <svg viewBox="0 0 16 16" fill="none" {...props}>
      ...
      <defs>
        ...
        <filter
          id="store_twake_svg__filter0_d_11291_1430"
          x={1.387}
          y={2.203}
          width={13.304}
          height={11.993}
