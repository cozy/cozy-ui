// Automatically created, please run `scripts/generate-svgr-icon.sh assets/icons/twake/openwith_twake.svg` to regenerate;
import React from 'react'

function SvgOpenwithTwake(props) {
  return (
...
export default SvgOpenwithTwake
