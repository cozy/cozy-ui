...
const ActionMenuWrapper = forwardRef(
  ({ onClose, fileId, name, value }, ref) => {
    ...
    const path = `#/paper/edit/${currentModel}/${fileId}?${
    ...
    const handleCopy = () => {
      if (navigator?.clipboard) {
        ...
        showViewerSnackbar(
          'error',
          t(`Viewer.snackbar.copiedToClipboard.error`)
        )
      }
      onClose()
    }
                    ...
                    {({ onClick, href }) => {
                      return (
                        ...
                        >
                          ...
                          <ListItemText
                            primary={t(
                              `Viewer.panel.qualification.actions.edit`
                            )}
                          />
                        </ListItem>
                      )
