...
testComponent('ActionMenu', { delay: 500 }) // Prints error because of Dialog usage
...
testComponent('Text') // Prints error: test was not wrapped in act()
...
testComponent('Viewer') // Prints error: test was not wrapped in act()
